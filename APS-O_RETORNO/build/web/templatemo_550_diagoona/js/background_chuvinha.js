// var Renderer -> serve para renderizar todos os componentes do background
var RENDERER = {
	...
	init : function(){
        ...
        //Passa todos os parametros como altura largura e etc...
	...
	createHumans : function(){
        ...
        //Renderização de fundo / Humanos / Sombras dos Humanos / Chuva / Mudança de Coloração de chuva 
	render : function(){
		requestAnimationFrame(this.render);
		
		this.color = this.COLOR.replace('%hue', 300 * Math.sin(this.phi));
...
//`Propriedades da Chuva(Velocidade da chuva, chance da chuva cair, Vento e etc)
RAIN_DROP.prototype = {
...
//Propriedades do humano(tamanho, sombra e etc)
HUMAN.prototype = {
